...
bool test_all_cases_spurs_and_bracket(bool draw, unsigned int testtorun)
{
  bool res=true;
  LCC_3_cmap lcc;
  if (!CGAL::load_off(lcc, CGAL::data_file_path("test/Surface_mesh_topology/cube-mesh-5-5.off")))
  {
  ...
  lcc.clear();
  if (!CGAL::load_off(lcc, CGAL::data_file_path("test/Surface_mesh_topology/spiral-squared.off")))
  {
  ...
  lcc.clear();
  if (!CGAL::load_off(lcc, CGAL::data_file_path("test/Surface_mesh_topology/loop-squared.off")))
  {
    std::cout<<"PROBLEM reading file data/spiral-squared.off"<<std::endl;
    exit(EXIT_FAILURE);
  }
...
bool test_all_cases_l_shape(bool draw, unsigned int testtorun)
{
  ...
  lcc.clear();
  if (!CGAL::load_off(lcc, CGAL::data_file_path("test/Surface_mesh_topology/case4-right-shift-squared.off")))
  {
  ...
  lcc.clear();
  if (!CGAL::load_off(lcc, CGAL::data_file_path("test/Surface_mesh_topology/cases5-6-right-shift-squared.off")))
  {
  ...
  lcc.clear();
  if (!CGAL::load_off(lcc, CGAL::data_file_path("test/Surface_mesh_topology/case7-right-shift-squared.off")))
  {
