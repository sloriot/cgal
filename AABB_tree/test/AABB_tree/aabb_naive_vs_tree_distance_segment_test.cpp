...
int main(void)
{
  ...
  test_kernels<SEGMENT>(CGAL::data_file_path("test/AABB_tree/cube.off"),duration);
  test_kernels<SEGMENT>(CGAL::data_file_path("test/AABB_tree/coverrear.off"),duration);
  test_kernels<SEGMENT>(CGAL::data_file_path("test/AABB_tree/finger.off"),duration);
