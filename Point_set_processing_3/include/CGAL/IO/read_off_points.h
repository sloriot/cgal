...
template <typename OutputIterator,
          typename NamedParameters = parameters::Default_named_parameters>
bool read_OFF(std::istream& is, OutputIterator output, const NamedParameters& np = parameters::use_default_values(),
...
bool read_OFF(const std::string& fname, OutputIterator output, const NamedParameters& np = parameters::use_default_values(),
              typename std::enable_if<CGAL::is_iterator<OutputIterator>::value>::type* = nullptr)
{
  std::ifstream is(fname);
  return read_OFF<typename value_type_traits<OutputIterator>::type>(is, output, np);
...
template <typename OutputIterator, typename NamedParameters = parameters::Default_named_parameters>
CGAL_DEPRECATED bool read_off_points(std::istream& is, OutputIterator output, const NamedParameters& np = parameters::use_default_values())
{
  return read_OFF(is, output, np);
}
