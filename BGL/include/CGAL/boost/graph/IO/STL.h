...
bool read_STL(const std::string& fname,
              Graph& g, const NamedParameters& np =  parameters::use_default_values())
{
...
*/
template <typename Graph, typename NamedParameters = parameters::Default_named_parameters>
bool write_STL(const std::string& fname, const Graph& g, const NamedParameters& np = parameters::use_default_values())
{
