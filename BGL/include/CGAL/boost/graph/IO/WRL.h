...
*/
template <typename Graph, typename NamedParameters = parameters::Default_named_parameters>
bool write_WRL(const std::string& fname, const Graph& g, const NamedParameters& np = parameters::use_default_values())
{
...
*/
template <typename Graph, typename NamedParameters = parameters::Default_named_parameters>
CGAL_DEPRECATED bool write_wrl(std::ostream& os, const Graph& g, const NamedParameters& np = parameters::use_default_values())
{
  return write_WRL(os, g, np);
}
