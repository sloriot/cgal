...
public:
  ...
  {
    return Unfiltered_predicate_adaptor<typename Unfiltering::Compare_ss_event_times_2>(const_cast<CGAL_SS_i::Time_cache<K>&>(time_cache));
  }

  Do_ss_event_exist_2
  get(Do_ss_event_exist_2 const* = 0 ) const
  {
    return Unfiltered_predicate_adaptor<typename Unfiltering::Do_ss_event_exist_2>(const_cast<CGAL_SS_i::Time_cache<K>&>(time_cache));
  }

  Are_ss_events_simultaneous_2
  get(Are_ss_events_simultaneous_2 const* = 0 ) const
  {
    return Unfiltered_predicate_adaptor<typename Unfiltering::Are_ss_events_simultaneous_2>(const_cast<CGAL_SS_i::Time_cache<K>&>(time_cache));
  }

  Construct_ss_event_time_and_point_2
  get(Construct_ss_event_time_and_point_2 const* = 0 ) const
  {
    return typename Unfiltering::Construct_ss_event_time_and_point_2(const_cast<CGAL_SS_i::Time_cache<K>&>(time_cache));
  }
...
class Straight_skeleton_builder_traits_2_impl<Tag_true,K> : public Straight_skeleton_builder_traits_2_base<K>
{
  ...
  typedef Straight_skeleton_builder_traits_2_functors<FK> Filtering ; // TODO: uncertain is needed here!
  typedef Straight_skeleton_builder_traits_2_functors<K>  Unfiltering ;
