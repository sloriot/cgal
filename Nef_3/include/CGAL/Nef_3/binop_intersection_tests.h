...
struct binop_intersection_test_segment_tree {
  ...
  struct Bop_edge0_edge1_callback  {
    ...
    : is(is), cb(cb), simplify_redundant_edges(sce)
    {}
    ...
    void operator()( Nef_box& box0, Nef_box& box1 ) {
      ...
      if( is.does_intersect_internally( Const_decorator::segment( e0 ),
        ...
        cb(e0,make_object(e1),ip, simplify_redundant_edges);
    }
  };
                  ...
                  bool simplify_redundant_edges)
  {
    ...
    Bop_edge0_edge1_callback<Callback> callback_edge0_edge1( is, cb0, simplify_redundant_edges );
