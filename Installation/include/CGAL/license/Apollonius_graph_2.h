...
#    if defined(CGAL_LICENSE_WARNING)
       ...
       CGAL_pragma_warning("Your commercial license for CGAL does not cover "
                           "this release of the 2D Apollonius Graphs (Delaunay Graphs of Disks) package.")
#    endif
...
#else // no CGAL_APOLLONIUS_GRAPH_2_COMMERCIAL_LICENSE

#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("\nThe macro CGAL_APOLLONIUS_GRAPH_2_COMMERCIAL_LICENSE is not defined."
                          "\nYou use the CGAL 2D Apollonius Graphs (Delaunay Graphs of Disks) package under "
