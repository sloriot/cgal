...
#  if CGAL_ENVELOPE_3_COMMERCIAL_LICENSE < CGAL_RELEASE_DATE

#    if defined(CGAL_LICENSE_WARNING)

       CGAL_pragma_warning("Your commercial license for CGAL does not cover "
                           "this release of the 3D Envelopes package.")
#    endif
...
#else // no CGAL_ENVELOPE_3_COMMERCIAL_LICENSE

#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("\nThe macro CGAL_ENVELOPE_3_COMMERCIAL_LICENSE is not defined."
                          "\nYou use the CGAL 3D Envelopes package under "
