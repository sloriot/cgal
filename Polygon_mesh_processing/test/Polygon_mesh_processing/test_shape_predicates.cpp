...
int main()
{
  check_edge_degeneracy(CGAL::data_file_path("test/Polygon_mesh_processing/data_degeneracies/degtri_edge.off"));
  check_triangle_face_degeneracy(CGAL::data_file_path("test/Polygon_mesh_processing/data_degeneracies/degtri_four.off"));

  test_needles_and_caps(CGAL::data_file_path("test/Polygon_mesh_processing/data_degeneracies/caps_and_needles.off"));
