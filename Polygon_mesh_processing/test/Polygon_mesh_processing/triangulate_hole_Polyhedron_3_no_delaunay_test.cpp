...
typedef CGAL::Surface_mesh<typename Kernel::Point_3> Polyhedron;
  ...
  test_triangulate_hole_should_be_no_output<Polyhedron>(CGAL::data_file_path("test/Polygon_mesh_processing/non_manifold_vertex.off"));
  test_triangulate_hole_should_be_no_output<Polyhedron>(CGAL::data_file_path("test/Polygon_mesh_processing/two_tris_collinear.off"));
