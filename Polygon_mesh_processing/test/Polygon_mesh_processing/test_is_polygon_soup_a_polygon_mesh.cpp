...
int main()
{
  ...
  test_polygon_soup<SC>(CGAL::data_file_path("test/Polygon_mesh_processing/joint_refined.off"), true);
  test_polygon_soup<SC>(CGAL::data_file_path("meshes/mech-holes-shark.off"), true);
  test_polygon_soup<SC>(CGAL::data_file_path("test/Polygon_mesh_processing/non_manifold_vertex.off"), false);
  test_polygon_soup<SC>(CGAL::data_file_path("test/Polygon_mesh_processing/two_tris_collinear.off"), true);
  test_polygon_soup<SC>(CGAL::data_file_path("test/Polygon_mesh_processing/U.off"), true);
