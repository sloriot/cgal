...
void test()
{
  ...
  {
    TriangleMesh tm1, tm2;
    std::ifstream(CGAL::data_file_path("test/Polygon_mesh_processing/data-clip/clipper_for_tet.off")) >> tm2;
    std::ifstream(CGAL::data_file_path("test/Polygon_mesh_processing/data-clip/tet_with_si_to_clip.off")) >> tm1;
  ...
  {
    TriangleMesh tm1, tm2;
    std::ifstream(CGAL::data_file_path("test/Polygon_mesh_processing/data-clip/tm_1.off")) >> tm2;
    std::ifstream(CGAL::data_file_path("test/Polygon_mesh_processing/data-clip/clipper_1.off")) >> tm2;
...
void test_split_plane()
{
  ...
  //test with SI
  std::ifstream(CGAL::data_file_path("test/Polygon_mesh_processing/data-clip/tet_si_to_split.off")) >> tm1;
  if(num_vertices(tm1) == 0)
  {
    std::cerr<<"File not found. Aborting."<<std::endl;
    assert(false);
...
void test_split()
{
  ...
  input.open(CGAL::data_file_path("test/Polygon_mesh_processing/data-clip/split_A.off"));
  input >> tm1;
  ...
  input.open(CGAL::data_file_path("test/Polygon_mesh_processing/data-clip/splitter.off"));
  input >> tm2;
  ...
  //test with SI
  std::ifstream(CGAL::data_file_path("test/Polygon_mesh_processing/data-clip/splitter_for_tet.off")) >> tm2;
  std::ifstream(CGAL::data_file_path("test/Polygon_mesh_processing/data-clip/tet_si_to_split.off")) >> tm1;
  //test with SI
...
void test_isocuboid()
{
  ...
  std::ifstream(CGAL::data_file_path("test/Polygon_mesh_processing/data-clip/tet_with_si_to_clip.off")) >> tm;
