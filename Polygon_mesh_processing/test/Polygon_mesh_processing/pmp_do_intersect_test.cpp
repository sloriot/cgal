...
int main()
{
  ...
  bool expected = true;
  const std::string filename1 =  CGAL::data_file_path("test/Polygon_mesh_processing/tetra1.off");
  ...
  const std::string filename7 =  CGAL::data_file_path("test/Polygon_mesh_processing/tetra2.off");
